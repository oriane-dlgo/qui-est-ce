...
- Implémenter une version jouable du jeu “Qui-est-ce ?”  
- Concevoir une architecture claire et modulaire en Kotlin en utilisant le MVC  
- Travailler en équipe avec Git pour gérer les versions du projet  
- Respecter les bonnes pratiques de programmation et documenter le code

## Fonctionnalités principales

- 🎭 Système de personnages avec les photos des personnes de notre promotion
- ❓ Mécanisme de questions/réponses permettant d’éliminer les suspects progressivement  
- 🎯 Sélection aléatoire d’un personnage secret  
- 🧩 Interface console simple pour jouer  
